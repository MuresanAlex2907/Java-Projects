...
public class View {
	...
	public JButton b5 = new JButton("Integral");
	public JButton b6 = new JButton("Differential");
	public JLabel result=new JLabel("");

	
	public JTextField p1=new JTextField("");
	public JTextField p2=new JTextField("");
