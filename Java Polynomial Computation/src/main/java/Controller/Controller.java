...
public class Controller {
	...
	public Controller() {
		...
		view.plus(e -> {
			String s = view.p1.getText();//get the strings from the polynomials text fields
			...
			if (ok == 1)//if the format is incorrect we print the correct format
				view.result.setText("Bad Format-> the format is a+bx+...+mx^n");
			else {
